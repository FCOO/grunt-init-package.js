...
module.exports = function(grunt) {
	...
	grunt.initConfig({
		"fcoo_grunt_plugin":{
			default: {
				"isApplication"								: {%= is_application %},	//true for stand-alone applications. false for packages/plugins
				...
				"haveGhPages"									: {%= have_ghpages %},		//Only for packages: true if there is a branch "gh-pages" used for demos
